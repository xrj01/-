...
import {Form,Input,Cascader,TreeSelect } from 'antd';
...
class addSub extends React.PureComponent {
    ...
    componentDidMount(){
        ...
        //console.log(11,this.props.editsub);
        //console.log(22,this.props.addSub);
        //console.log(this.props.singlrRowData.level);
    ...
    getDepartment = (id,tar) => {
        //console.log(this.props.singlrRowData);
        
        const data = {
            fid	: id,
            level : this.props.singlrRowData.level
        }
    ...
    // 级联回填
    cascadeBackfill(){
        //console.log(2222,this.props.getId);
