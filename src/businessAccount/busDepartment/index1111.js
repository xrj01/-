...
export default class busDepartment extends React.Component{
    ...
    render(){
        const {columns,data,addSub,count,department,singlrRowData,getId,page_number,page_size,total} = this.state;
        // 分页配置
        /* const pagination={
            total:total,
            pageSize:page_size,
        ...
        return(
            <div className='busDepartment-box'>
                <div className='busDepartment-container'>
                    ...
                    >
                    <AddSub wrappedComponentRef={(e)=>{this.addSub = e}} department={department} addSub={addSub} singlrRowData={singlrRowData} getId={getId}/>
                    </Modal>
                </div>
               <WinButton/>
            </div>
