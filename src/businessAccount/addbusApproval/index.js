...
class busApproval extends React.Component{
                    ...
                    <div className='busApproval-form'>
                        <Form onSubmit={this.handleSubmit}  {...formItemLayout}>
                            ...
                            <Form.Item label="审批流名称：">
                                ...
                                rules: [
                                    { required: true, message: '请输入审批流名称' },{max:20,message:'审批流名称不能超过20个字符'},{pattern: /^[\w\u4e00-\u9fa5\-_][\s\w\u4e00-\u9fa5\-_]*[\w\u4e00-\u9fa5\-_]$/, message: '审批流名称最少2个字符，首尾不能输入空格'}
                                ]
                                })(
                            ...
                            <Form.Item wrapperCol={{ span: 12, offset: 3 }} className='approve-btn-box'>
                                <Button htmlType="submit" className='approve-backbtn'>
                                    <Link to='/BusinessAccount/BusApproval'>返回审批流列表</Link>
                                </Button>
    ...
    handleOk = e =>{
        ...
        //console.log(1,index,2,selectedRows,3,modalData);
                    ...
                    if(getid){
                        ...
                        api.axiosPost('editApproval',editData).then((res)=>{
                            if(res.data.code ===1){
                                ...
                                history.push('/BusinessAccount/BusApproval')
                            }else{
